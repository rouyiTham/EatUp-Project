...
class ProductAdapter(private val productData: MutableList<WebDataItem>) : RecyclerView.Adapter<ProductAdapter.ViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.binding.foodText.text = productData[position].product_name
        ...
        val expiryDate: LocalDate = LocalDate.parse(productData[position].expiration_date ,df)
